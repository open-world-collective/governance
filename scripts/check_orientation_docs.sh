...
test -f "${ORIENTATION}"
test -f "${GLOSSARY}"
grep -F "(docs/getting-oriented.md)" README.md >/dev/null
grep -F "(docs/glossary.md)" README.md >/dev/null
grep -F "(docs/getting-oriented.md)" GOVERNANCE.md >/dev/null
grep -F "(docs/glossary.md)" GOVERNANCE.md >/dev/null
